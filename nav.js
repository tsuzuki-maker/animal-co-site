(function () {
  ...
  var css = [
    ...
    '.ra-logo-mark{width:36px;height:36px;border-radius:10px;background:var(--ra-grad-warm);display:flex;align-items:center;justify-content:center;color:#fff;font-weight:700;font-size:18px;}',
    ...
    '.ra-nav-cta{padding:10px 22px;border-radius:100px;background:var(--ra-grad-warm);color:#fff;font-size:13px;font-weight:700;letter-spacing:0.1em;cursor:pointer;border:none;}',
